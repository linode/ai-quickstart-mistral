...
#   Ubuntu instance to prepare it for AI Sandbox deployment. This replicates the
#   environment that would be provided by a Marketplace base image.
#
...
echo -e "${CYAN}=== Docker & NVIDIA Setup for AI Sandbox ===${NC}"
echo ""
